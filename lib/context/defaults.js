...
const globalFunctions = {
  // @todo eval
  isFinite:   new GenericFunction({ type: NODE_BUILTIN_METHOD_IMPL, targetClass: 'globalThis', name: 'isFinite' }, [{ name: 'testValue' }]),
...
const CONTEXT_DEFAULT = new Context(Object.freeze({
  ...
  isFinite: Object.freeze({ value: globalFunctions.isFinite, isConst: true, ignoreAssign: true }),
  // @todo check if values of isConst and ignoreAssign are correct
  ...
  // Array global constructor
  Array: Object.freeze({
    value: Object.freeze({
      isArray: new GenericFunction({ type: NODE_BUILTIN_METHOD_IMPL, targetClass: 'Array', name: 'isArray'  }, [{ name: 'value' }]),
    }),
    isConst: true, // @todo check if this value is correct
    ignoreAssign: true, // @todo check if this value is correct
  }),
