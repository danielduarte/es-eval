...
const evalBlockStatementNode = (node, context, target) => {
...
const evalArrowFunctionExpression = (node, target) => {
  ...
  return new implClasses.ArrowFunction(body, paramNames, false, true, target);
};
...
const evalFunctionExpression = (node, target) => {
  ...
  return new implClasses.ArrowFunction(body, paramNames, false, false, target);
};
