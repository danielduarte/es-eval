...
const evalFunctionExpression = node => {
...
const evalThisExpression = (node, context) => {
...
const evalExpressionNode = (node, context) => {
  switch (node.type) {
    ...
    case NODE_FUNCTION_EXPRESSION:       return evalFunctionExpression(node);
    ...
    case NODE_THIS_EXPRESSION:           return evalThisExpression(node, context);
